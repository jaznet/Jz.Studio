...
(function (f) {
  ...
  if (typeof exports === "object" && typeof module !== "undefined") {
    ...
    console.log("Techan.js is being executed"); // Add this to confirm execution
    g.techan = f();
  }
})(function () {
  var define, module, exports;

  //const d3 = require('d3'); // Or use `import * as d3 from 'd3';` if you prefer
