...
export interface ILayoutEventListener {
    ...
    onUndock?(dockManager: DockManager, dockNode: DockNode|undefined|null): void;
    ...
    onActivePanelChange?(dockManager: DockManager, panel?: PanelContainer|null, previousPanel?: PanelContainer|null): void;
  onActiveDocumentChange?(dockManager: DockManager, panel?: PanelContainer | null, previousPanel?: PanelContainer | null): void;
