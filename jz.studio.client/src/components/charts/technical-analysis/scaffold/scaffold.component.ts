...
export class ScaffoldComponent implements AfterViewInit, OnChanges, OnDestroy, OnInit {
 ...
 // scaffold!: Scaffold;
  ...
  constructor(
    ...
    ngOnInit(): void {
      ...
      this.scaffold = {
        titleHeight: 36,
        width: this.divSvgContainer.nativeElement.clientWidth,
        height: 400,
        margins: {
          bottom: 30,
          left: 30,
      ...
      this.scaffold.width = this.divSvgContainer.nativeElement.clientWidth;
      this.scaffold.height = this.divSvgContainer.nativeElement.clientWidth;
...
/*  protected  createChart(caller: string): void;*/

  //protected  drawYAxes(panel: PanelAttributes, yScale: any): void;
