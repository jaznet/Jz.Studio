...
export class IndicatorCatalogService {
  readonly definitions: readonly IndicatorDefinition[] = [
    ...
    { id: 'adx', name: 'Average Directional Index', placement: 'panel', defaultPeriod: 14 },
    { id: 'aroon', name: 'Aroon', placement: 'panel', defaultPeriod: 25 },
    { id: 'bollinger-width', name: 'Bollinger Band Width', placement: 'panel', defaultPeriod: 20 },
